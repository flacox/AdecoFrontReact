    ...
    <DashboardLayout>
      ...
      <div className="p-2">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          {/* Modal para agregar usuarios */}
          <CuentaModalAdd bancos={bancos} cargarCuentas={cargarCuentas} />
        </div>
                    ...
                    <tr key={account.id_account}>
                      ...
                      <td>
                        <button
                          ...
                          onClick={() => setCuentaSeleccionada(account)}
                        >
                          Editar
                        </button>

                        {/* Modal editar Banco */}
                        <CuentasModalEdit cuenta={account} cargarCuentas={cargarCuentas} bancos={bancos} />
