...
export default function BancoModalEdit({banco, cargarBancos}) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        await axios.put(`http://localhost:4000/api/bancos/${banco.id_bank}`, form);
        cargarBancos();        
    } catch (error) {
        console.error("Ocurrio un error al intentar actualizar el registro");
    }
  }
